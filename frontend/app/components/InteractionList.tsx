...
export default function InteractionList({ typeStr, profiles, toggleShow }: InteractionListProps) {
    return (
        <>
            ...
            <button className="mt-2 bg-gradient-to-r-main rounded-full hover:brightness-95 duration-150 w-16 h-10 text-white right-0 border-2"
                onClick={toggleShow}>See all</button>
